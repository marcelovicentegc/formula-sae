...
//Variaveis globais
int acelX,acelY,acelZ,temp,giroX,giroY,giroZ;
...
void loop()
{
  ...
  Serial.print("\tTemperatura: ");    Serial.println(temp/340.00+36.53);
  
  //Envia valores lidos do potenciômetro 
  Serial.print("\tPotênciometro: "); Serial.println(valor);
